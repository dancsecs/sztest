...
func chkBoolTestBadWithMsg1(t *testing.T) {
	...
	iT.check(t,
		chkOutCapture("Nothing"),
		chkOutIsError("Bool",
			chkOutCommonMsg("This message will be displayed first", boolTypeName),
			g(markAsChg("false", "true", DiffGot)),
			w(markAsChg("false", "true", DiffWant)),
		),
		chkOutRelease(),
...
func chkBoolTestBadWithMsg2(t *testing.T) {
	...
	iT.check(t,
		chkOutCapture("Nothing"),
		chkOutIsError("Bool",
			chkOutCommonMsg("This message will be displayed second", boolTypeName),
...
func chkBoolTestBadWithMsg3(t *testing.T) {
	...
	iT.check(t,
		chkOutCapture("Nothing"),
		chkOutIsError("Bool",
			chkOutCommonMsg("This message will be displayed third", boolTypeName),
			g(markAsChg("true", "false", DiffGot)),
			w(markAsChg("true", "false", DiffWant)),
		),
		chkOutRelease(),
