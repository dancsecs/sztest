...
func tstChkFloat64(t *testing.T) {
	t.Run("Good", chkFloat64Test_Good)

	t.Run("Bad", chkFloat64Test_Bad)
	t.Run("BadMsg1", chkFloat64Test_Bad1)
	t.Run("BadMsg2", chkFloat64Test_Bad2)
	t.Run("BadMsg3", chkFloat64Test_Bad3)

	t.Run("Slice-Good", chkFloat64SliceTest_Good)
	t.Run("Slice-BadMsg1", chkFloat64SliceTest_BadMsg1)
	t.Run("Slice-BadMsg2", chkFloat64SliceTest_BadMsg2)
	t.Run("Slice-BadMsg3", chkFloat64SliceTest_BadMsg3)
	t.Run("Slice-BadMsg4", chkFloat64SliceTest_BadMsg4)
	t.Run("Slice-BadMsg5", chkFloat64SliceTest_BadMsg5)
	t.Run("Slice-BadMsg6", chkFloat64SliceTest_BadMsg6)
	t.Run("Slice-BadMsg7", chkFloat64SliceTest_BadMsg7)
	t.Run("Slice-BadMsg8", chkFloat64SliceTest_BadMsg8)
	t.Run("Slice-BadMsg9", chkFloat64SliceTest_BadMsg9)

	t.Run("Bounded", chkFloat64BoundedTest_All)
	t.Run("Unbounded", chkFloat64UnboundedTest_All)
}
...
func chkFloat64SliceTest_Good(t *testing.T) {
	...
	chk.Float64Slicef(
		[]float64{0.02, 0.06, -.07, 9.0}, []float64{0.01, 0.05, -0.08, 9.0}, 0.1,
...
func chkFloat64BoundedTest_All(t *testing.T) {
	...
	iT.check(t,
		...
		chkOutNumericBounded_(wntMsg, "30", fName, "float64", ""),
		chkOutNumericBounded_(wntMsg, "31", fName, "float64", "msg:31"),
		chkOutNumericBoundedf(wntMsg, "32", fName, "float64", "msg:32"),

		chkOutNumericBounded_(wntMsg, "36", fName, "float64", ""),
...
func chkFloat64UnboundedTest_All(t *testing.T) {
	...
	iT.check(t,
		...
		chkOutNumericUnbounded_(wntMsg, "125", fName, "float64", ""),
		chkOutNumericUnbounded_(wntMsg, "126", fName, "float64", "msg:126"),
